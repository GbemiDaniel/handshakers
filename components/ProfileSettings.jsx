      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 id="profile-settings-title" className="text-base font-semibold text-slate-900 tracking-tight leading-tight">
                Profile Settings
              </h2>
            ...
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  readOnly
                  value={userEmail}
                  className="w-full h-11 px-4 bg-slate-100 border border-slate-200 rounded-xl text-slate-500 text-sm font-medium cursor-not-allowed select-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 p-3.5 bg-slate-50 border border-slate-200/80 rounded-xl">
                  ...
                  <div className="flex-1 flex items-center justify-between min-w-0">
                    <span className="text-xs text-slate-600 font-medium truncate">System Role</span>
                    <span
                    ...
                    >
                      {role === "admin" && <Sparkles className="w-3 h-3 text-purple-600" />}
                      {role}
                    </span>
                  </div>
                </div>
