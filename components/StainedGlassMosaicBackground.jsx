...
function StainedGlassMosaicBackground() {
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
      ...
      <svg
        className="absolute top-0 left-0 w-[450px] h-[120vh] md:drop-shadow-[0_0_10px_rgba(6,182,212,0.15)]"
      ...
      <svg
        className="absolute top-0 right-0 w-[450px] h-[120vh] md:drop-shadow-[0_0_10px_rgba(6,182,212,0.15)]"
        viewBox="0 0 450 1400"
